...
echo "==========================================================="
echo "  ox-orchestrator Installer (Linux / macOS)"
echo "==========================================================="
...
if [ -z "${TAG}" ]; then
  echo "[!] Could not fetch latest release via API, defaulting to v0.2.1"
  TAG="v0.2.1"
fi
...
mv "${TMP_DIR}/${ARCHIVE_NAME}/ox" "${INSTALL_DIR}/ox"
chmod +x "${INSTALL_DIR}/ox"

echo ""
echo "==========================================================="
echo "  ✓ Successfully installed ox to ${INSTALL_DIR}/ox"
echo "==========================================================="
echo ""
...
echo "Run 'ox --help' or 'ox chat' to get started!"
